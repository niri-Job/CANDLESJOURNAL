    ...
    <div className="min-h-screen bg-[var(--cj-bg)] flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-10">
          <div
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#F5C518] to-[#C9A227]
        ...
        <div className="bg-[var(--cj-surface)] rounded-2xl p-7"
          ...
          <button
            ...
            disabled={loading}
            className="btn-gold mt-5 w-full py-3 rounded-xl text-sm tracking-wide transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
          >
